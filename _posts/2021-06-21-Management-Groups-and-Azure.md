...
When working in the regulated industries  you'll find it best to group subscriptions at the portfolio level. This allows an organization to assign the portfolio owners at the top level of the management group so that they have insight into their entire business from a single pane of glass and run cost reports across the environment to keep track of spending and audit what is being deployed into their portfolio.
